...
def test_initialize_success():
    ...
    with patch("lilypad.server.services.kafka.get_settings") as mock_get_settings:
        ...
        with patch("lilypad.server.services.kafka.KafkaProducer", return_value=mock_producer):
...
def test_initialize_failure():
    ...
    with patch("lilypad.server.services.kafka.get_settings") as mock_get_settings:
        ...
        with patch("lilypad.server.services.kafka.KafkaProducer") as mock_producer_class:
