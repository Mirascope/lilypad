...
@pytest.fixture
def organization_invite_service(
    db_session: Session, test_user: UserPublic
...
def test_organization_invite(
    organization_invite_service: OrganizationInviteService, db_session: Session
    ...
    invite = organization_invite_service.create_record(
        invite_data, resend_email_id="test_resend_id"
    )
    db_session.commit()
...
def test_find_record_by_token_multiple_invites(
    ...
    invite1 = organization_invite_service.create_record(
        invite1_data, resend_email_id="resend_id_1"
    )
    ...
    invite2 = organization_invite_service.create_record(
        invite2_data, resend_email_id="resend_id_2"
    )
    ...
    invite3 = organization_invite_service.create_record(
        invite3_data, resend_email_id="resend_id_3"
    )
...
def test_find_record_by_token_with_similar_tokens(
    ...
    invite1 = organization_invite_service.create_record(
        invite1_data, resend_email_id="resend_abc_1"
    )
    ...
    invite2 = organization_invite_service.create_record(
        invite2_data, resend_email_id="resend_abc_2"
    )
...
def test_create_record_adds_all_fields(
    ...
    created_invite = organization_invite_service.create_record(
        invite_data, resend_email_id="unique_resend_id"
    )
