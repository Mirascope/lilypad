...
class TestSecretManagerFactory:
    """Test Secret Manager Factory functionality."""

    def test_get_supabase_vault_manager_with_session(self):
    ...
    def test_get_supabase_vault_manager_without_session_raises_error(self):
    ...
    @mock_aws
    def test_get_aws_secret_manager(self):
    ...
    @mock_aws
    def test_get_aws_secret_manager_with_custom_region(self):
    ...
    def test_get_manager_from_settings_supabase(self):
    ...
    @mock_aws
    def test_get_manager_from_settings_aws(self):
    ...
    def test_get_manager_with_invalid_settings_type(self):
    ...
    def test_default_manager_type_is_supabase(self):
    ...
    @mock_aws
    def test_aws_manager_uses_default_region_when_not_set(self):
    ...
    def test_explicit_manager_type_overrides_settings(self):
