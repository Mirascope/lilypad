...
def test_convert_openai_messages_with_text_dict():
    ...
    messages = [
        {
            "name": "gen_ai.user.message",
            "attributes": {"content": '[{"text": "Hello world"}]'},
        }
    ]
...
def test_convert_gemini_messages_with_text_dict():
    ...
    messages = [
        {
            "name": "gen_ai.user.message",
            "attributes": {"content": '[{"text": "Hello from Gemini"}]'},
        }
    ]
    ...
    messages = [
        {
            ...
            "attributes": {"content": '["System instruction"]'},
        }
    ]
...
def test_convert_anthropic_messages_with_text_dict():
    ...
    messages = [
        {
            "name": "gen_ai.user.message",
            "attributes": {"content": '[{"text": "Hello from Anthropic"}]'},
        }
    ]
...
def test_convert_anthropic_choice_with_index():
    ...
    messages = [
        {
            "name": "gen_ai.choice",
            "attributes": {"index": 0, "message": '{"content": "Anthropic response"}'},
        }
    ]
...
def test_convert_anthropic_system_message():
    ...
    messages = [
        {
            "name": "gen_ai.system.message",
            "attributes": {"content": '["System message from Anthropic"]'},
        }
    ]
...
def test_gemini_choice_content_processing():
    ...
    messages = [
        {
            "name": "gen_ai.choice",
            "attributes": {"index": 0, "message": '{"content": ["Part 1", "Part 2"]}'},
        }
    ]
    ...
    messages = [
        {
            "name": "gen_ai.user.message",
            "attributes": {
                "content": json.dumps([{"type": "text", "text": "Hello from dict"}])
            },
        }
    ]
...
def test_convert_openai_messages_tool_calls_processing():
    ...
    assert hasattr(content, "arguments") and content.arguments == {
        "location": "New York"
    }
    ...
    messages = [
        {
            "role": "user",
            "content": [
                {"type": "audio", "media_type": "audio/wav", "audio": "base64audio"}
            ],
        }
    ]
...
def test_convert_mirascope_messages_text_content_processing():
    ...
    messages = [
        {"role": "user", "content": [{"type": "text", "text": "Hello from text dict"}]}
    ]
...
def test_convert_mirascope_messages_string_content_processing():
    ...
    messages = [{"role": "user", "content": ["Hello as string"]}]
...
def test_span_more_details_openai_image_processing():
    ...
    span.data = {
        ...
        "attributes": {"lilypad.provider": "openai"},
    }
...
def test_span_more_details_openai_tool_calls():
    ...
    span.data = {
        "name": "OpenAI Chat Completion",
        "input": {"messages": [{"role": "user", "content": "Call a function"}]},
        "output": {
            "choices": [
                {
                    "message": {
