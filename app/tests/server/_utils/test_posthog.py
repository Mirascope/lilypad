...
def test_get_posthog_client():
    ...
    with patch("lilypad.server._utils.posthog.get_settings") as mock_get_settings:
        ...
        with patch("lilypad.server._utils.posthog.posthog.Posthog") as mock_posthog_class:
            mock_client = Mock()
...
def test_posthog_middleware_init():
    ...
    should_capture = lambda req: True
...
def test_setup_posthog_middleware():
    ...
    with patch("lilypad.server._utils.posthog.PosthogMiddleware") as mock_middleware_class:
