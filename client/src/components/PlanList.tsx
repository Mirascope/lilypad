              ...
              <div key={tierKey} className="inline-block">
                {isCurrentPlan ? (
                  ...
                  >
                    <div className="p-4">
                      <p>
                        Please email us at <a href="mailto:support@mirascope.com"
                                              className="text-blue-500 hover:underline">support@mirascope.com</a> to
                        request an upgrade to the {tierName} plan.
                      </p>
                      {isTeamOrProPlus && (
                        <p className="mt-2">
