...
export const fetchComments = async () =>
  (await api.get<CommentPublic[]>("/comments")).data;
...
export const patchComment = async (
  ...
  return (
    await api.patch<CommentPublic>(`/comments/${commentUuid}`, commentUpdate)
  ).data;
};
...
export const useCreateCommentMutation = () => {
  ...
  return useMutation({
    mutationFn: async (commentCreate: CommentCreate) =>
      await postComment(commentCreate),
