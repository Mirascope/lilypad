...
class OrganizationInvitePublic(BaseModel):
    ...
    user: UserPublic
    resend_email_id: StrictStr
    invite_link: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["invited_by", "email", "expires_at", "uuid", "organization_uuid", "user", "resend_email_id", "invite_link"]
