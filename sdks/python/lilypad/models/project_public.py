...
class ProjectPublic(BaseModel):
    ...
    created_at: datetime
    __properties: ClassVar[List[str]] = ["name", "uuid", "functions", "created_at"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "uuid": obj.get("uuid"),
            "functions": [FunctionPublic.from_dict(_item) for _item in obj["functions"]] if obj.get("functions") is not None else None,
