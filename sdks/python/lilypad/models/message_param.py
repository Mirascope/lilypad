...
class MessageParam(BaseModel):
    ...
    """ # noqa: E501
    role: StrictStr
    content: List[MessageParamContentInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "role": obj.get("role"),
            "content": [MessageParamContentInner.from_dict(_item) for _item in obj["content"]] if obj.get("content") is not None else None
        })
        return _obj
