...
class APIKeyCreate(BaseModel):
    ...
    key_hash: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["name", "expires_at", "project_uuid", "environment_uuid", "key_hash"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if key_hash (nullable) is None
        # and model_fields_set contains the field
        if self.key_hash is None and "key_hash" in self.model_fields_set:
            _dict['key_hash'] = None
