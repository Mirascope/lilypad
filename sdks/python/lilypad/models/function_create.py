...
class FunctionCreate(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["project_uuid", "version_num", "name", "signature", "code", "hash", "dependencies", "arg_types", "archived", "custom_id", "prompt_template", "provider", "model", "call_params", "is_versioned"]
