...
ARGVALUESVALUE_ANY_OF_SCHEMAS = ["List[object]", "bool", "float", "int", "object", "str"]

class ArgValuesValue(BaseModel):
    """
    ArgValuesValue
    """
    ...
    def actual_instance_must_validate_anyof(cls, v):
        instance = ArgValuesValue.model_construct()
        error_messages = []
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in ArgValuesValue with anyOf schemas: List[object], bool, float, int, object, str. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into ArgValuesValue with anyOf schemas: List[object], bool, float, int, object, str. Details: " + ", ".join(error_messages))
        else:
            return instance
