...
class ExternalAPIKeyPublic(BaseModel):
    ...
    masked_api_key: StrictStr = Field(description="Partially masked API key")
    __properties: ClassVar[List[str]] = ["service_name", "masked_api_key"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "masked_api_key": obj.get("masked_api_key")
        })
        return _obj
