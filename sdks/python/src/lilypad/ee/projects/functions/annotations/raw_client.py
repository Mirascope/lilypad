...
class RawAnnotationsClient:
    ...
    def list(
        ...
        _response = self._client_wrapper.httpx_client.request(
            f"ee/projects/{jsonable_encoder(project_uuid)}/functions/{jsonable_encoder(function_uuid)}/annotations",
            method="GET",
    ...
    def get_metrics(
    ...
    ) -> HttpResponse[AnnotationMetrics]:
        """
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"ee/projects/{jsonable_encoder(project_uuid)}/functions/{jsonable_encoder(function_uuid)}/annotations/metrics",
            method="GET",
            request_options=request_options,
        )
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    AnnotationMetrics,
                    construct_type(
                        type_=AnnotationMetrics,  # type: ignore
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
...
class AsyncRawAnnotationsClient:
    ...
    async def get_metrics(
        self, function_uuid: str, project_uuid: str, *, request_options: typing.Optional[RequestOptions] = None
    ) -> AsyncHttpResponse[AnnotationMetrics]:
        """
        Get annotation metrics by function.
