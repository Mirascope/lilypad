...
class RawWebhooksClient:
    ...
    def handle_stripe(
    ...
    ) -> HttpResponse[StripeWebhookResponse]:
        """
        ...
        _response = self._client_wrapper.httpx_client.request(
            ...
            method="POST",
            headers={
                "Stripe-Signature": str(stripe_signature) if stripe_signature is not None else None,
            },
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    construct_type(
                        type_=StripeWebhookResponse,  # type: ignore
...
class AsyncRawWebhooksClient:
    ...
    async def handle_stripe(
        self, *, stripe_signature: typing.Optional[str] = None, request_options: typing.Optional[RequestOptions] = None
    ) -> AsyncHttpResponse[StripeWebhookResponse]:
        """
        Handle Stripe webhook events.
