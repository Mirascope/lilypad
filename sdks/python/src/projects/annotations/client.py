...
class AnnotationsClient:
    ...
    def create(
        ...
        *,
        ...
        Examples
        --------
        from mirascope import AnnotationCreate, Mirascope

        client = Mirascope(
            api_key="YOUR_API_KEY",
            token="YOUR_TOKEN",
        )
        client.projects.annotations.create(
            project_uuid="project_uuid",
    ...
    def update(
        ...
        *,
        ...
        client.projects.annotations.update(
            annotation_uuid="annotation_uuid",
            project_uuid="project_uuid",
        )
        """
...
class AsyncAnnotationsClient:
    ...
    async def create(
        ...
        *,
        ...
        from mirascope import AnnotationCreate, AsyncMirascope
        ...
        async def main() -> None:
            await client.projects.annotations.create(
                project_uuid="project_uuid",
                request=[AnnotationCreate()],
            )
    ...
    async def update(
        ...
        *,
        ...
        async def main() -> None:
            await client.projects.annotations.update(
                annotation_uuid="annotation_uuid",
                project_uuid="project_uuid",
            )
