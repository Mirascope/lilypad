...
def test_context_with_extract_from():
...
def test_context_with_both_raises_error():
    ...
    with (
        ...
        context(parent=parent_ctx, extract_from=headers),
    ):
        pass


def test_context_with_neither_parameter():
...
def test_context_detaches_on_exception_with_parent():
...
def test_context_none_token_not_detached():
