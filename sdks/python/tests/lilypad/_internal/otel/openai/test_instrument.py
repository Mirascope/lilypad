...
def test_instrumentation_idempotent():
    ...
    instrument_openai(client)
    third_create = client.chat.completions.create
    third_parse = client.chat.completions.parse

    assert third_create is first_create
    assert third_parse is first_parse
