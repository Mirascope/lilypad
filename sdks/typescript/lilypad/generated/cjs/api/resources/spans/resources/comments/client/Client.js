...
class Comments {
     ...
     */
    list(spanUuid, requestOptions) {
        return core.HttpResponsePromise.fromPromise(this.__list(spanUuid, requestOptions));
    }
    __list(spanUuid, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            var _a, _b;
            const _response = yield core.fetcher({
                url: core.joinUrl((_a = (yield core.Supplier.get(this._options.baseUrl))) !== null && _a !== void 0 ? _a : (yield core.Supplier.get(this._options.environment)), `spans/${encodeURIComponent(spanUuid)}/comments`),
                method: "GET",
            ...
            switch (_response.error.reason) {
                ...
                case "timeout":
                    throw new errors.MirascopeApiTimeoutError("Timeout exceeded when calling GET /spans/{span_uuid}/comments.");
                case "unknown":
                    throw new errors.MirascopeApiError({
