...
exports.ExternalApiKeys = void 0;
...
class ExternalApiKeys {
    ...
    __list(requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const _response = yield core.fetcher({
                url: core.joinUrl((_a = (yield core.Supplier.get(this._options.baseUrl))) !== null && _a !== void 0 ? _a : (yield core.Supplier.get(this._options.environment)), "external-api-keys"),
                method: "GET",
     ...
     */
    get(serviceName, requestOptions) {
        return core.HttpResponsePromise.fromPromise(this.__get(serviceName, requestOptions));
    }
    __get(serviceName, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            var _a, _b;
            const _response = yield core.fetcher({
                url: core.joinUrl((_a = (yield core.Supplier.get(this._options.baseUrl))) !== null && _a !== void 0 ? _a : (yield core.Supplier.get(this._options.environment)), `external-api-keys/${encodeURIComponent(serviceName)}`),
                method: "GET",
                headers: (0, headers_js_1.mergeHeaders)((_b = this._options) === null || _b === void 0 ? void 0 : _b.headers, (0, headers_js_1.mergeOnlyDefinedHeaders)({
                    Authorization: yield this._getAuthorizationHeader(),
                    "X-API-Key": requestOptions === null || requestOptions === void 0 ? void 0 : requestOptions.apiKey,
...
exports.ExternalApiKeys = ExternalApiKeys;
