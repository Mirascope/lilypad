...
export declare class Annotations {
     ...
     */
    list(projectUuid: string, requestOptions?: Annotations.RequestOptions): core.HttpResponsePromise<Lilypad.AnnotationPublic[]>;
    private __list;
    /**
     ...
     */
    create(projectUuid: string, request: Lilypad.AnnotationCreate[], requestOptions?: Annotations.RequestOptions): core.HttpResponsePromise<Lilypad.AnnotationPublic[]>;
    private __create;
    /**
     ...
     */
    update(annotationUuid: string, projectUuid: string, request?: Lilypad.ee.projects.AnnotationUpdate, requestOptions?: Annotations.RequestOptions): core.HttpResponsePromise<Lilypad.AnnotationPublic>;
    private __update;
