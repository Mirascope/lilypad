...
class Annotations {
     ...
     */
    list(projectUuid, spanUuid, requestOptions) {
        return core.HttpResponsePromise.fromPromise(this.__list(projectUuid, spanUuid, requestOptions));
    }
    __list(projectUuid, spanUuid, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            var _a, _b;
            const _response = yield core.fetcher({
                url: core.joinUrl((_a = (yield core.Supplier.get(this._options.baseUrl))) !== null && _a !== void 0 ? _a : (yield core.Supplier.get(this._options.environment)), `ee/projects/${encodeURIComponent(projectUuid)}/spans/${encodeURIComponent(spanUuid)}/annotations`),
                method: "GET",
            ...
            switch (_response.error.reason) {
                ...
                case "timeout":
                    throw new errors.MirascopeApiTimeoutError("Timeout exceeded when calling GET /ee/projects/{project_uuid}/spans/{span_uuid}/annotations.");
                case "unknown":
                    throw new errors.MirascopeApiError({
