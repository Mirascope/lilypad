...
class Functions {
     ...
     *     })
     */
    runPlayground(projectUuid, functionUuid, request, requestOptions) {
        return core.HttpResponsePromise.fromPromise(this.__runPlayground(projectUuid, functionUuid, request, requestOptions));
    }
    __runPlayground(projectUuid, functionUuid, request, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            var _a, _b;
            const _response = yield core.fetcher({
                url: core.joinUrl((_a = (yield core.Supplier.get(this._options.baseUrl))) !== null && _a !== void 0 ? _a : (yield core.Supplier.get(this._options.environment)), `ee/projects/${encodeURIComponent(projectUuid)}/functions/${encodeURIComponent(functionUuid)}/playground`),
                method: "POST",
