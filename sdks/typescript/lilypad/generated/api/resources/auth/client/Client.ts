...
export class Auth {
     ...
     *     })
     */
    public handleGithubCallback(
        request: Lilypad.AuthHandleGithubCallbackRequest,
    ...
    private async __handleGithubCallback(
        request: Lilypad.AuthHandleGithubCallbackRequest,
        requestOptions?: Auth.RequestOptions,
