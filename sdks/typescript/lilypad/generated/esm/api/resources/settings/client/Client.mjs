    ...
    __get(requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const _response = yield core.fetcher({
                url: core.joinUrl((_a = (yield core.Supplier.get(this._options.baseUrl))) !== null && _a !== void 0 ? _a : (yield core.Supplier.get(this._options.environment)), "settings"),
                method: "GET",
            ...
            switch (_response.error.reason) {
                ...
                case "timeout":
                    throw new errors.MirascopeApiTimeoutError("Timeout exceeded when calling GET /settings.");
                case "unknown":
                    throw new errors.MirascopeApiError({
