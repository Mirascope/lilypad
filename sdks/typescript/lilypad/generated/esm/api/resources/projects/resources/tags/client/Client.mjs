    ...
    __list(projectUuid, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const _response = yield core.fetcher({
                url: core.joinUrl((_a = (yield core.Supplier.get(this._options.baseUrl))) !== null && _a !== void 0 ? _a : (yield core.Supplier.get(this._options.environment)), `projects/${encodeURIComponent(projectUuid)}/tags`),
                method: "GET",
            ...
            switch (_response.error.reason) {
                ...
                case "timeout":
                    throw new errors.MirascopeApiTimeoutError("Timeout exceeded when calling GET /projects/{project_uuid}/tags.");
                case "unknown":
                    throw new errors.MirascopeApiError({
