...
export declare class Environments {
     ...
     *     })
     */
    deploy(projectUuid: string, environmentUuid: string, request: Lilypad.projects.EnvironmentsDeployRequest, requestOptions?: Environments.RequestOptions): core.HttpResponsePromise<Lilypad.DeploymentPublic>;
    private __deploy;
    /**
     ...
     */
    getActiveDeployment(projectUuid: string, environmentUuid: string, requestOptions?: Environments.RequestOptions): core.HttpResponsePromise<Lilypad.DeploymentPublic>;
     ...
     */
    getFunction(projectUuid: string, environmentUuid: string, requestOptions?: Environments.RequestOptions): core.HttpResponsePromise<Lilypad.FunctionPublic>;
     ...
     */
    getDeploymentHistory(projectUuid: string, environmentUuid: string, requestOptions?: Environments.RequestOptions): core.HttpResponsePromise<Lilypad.DeploymentPublic[]>;
