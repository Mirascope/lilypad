...
export declare class Traces {
     ...
     */
    getRoot(projectUuid: string, spanId: string, requestOptions?: Traces.RequestOptions): core.HttpResponsePromise<MirascopeApi.SpanPublic>;
    private __getRoot;
    /**
     * Get traces by project UUID.
     *
     ...
     */
    list(projectUuid: string, request?: MirascopeApi.projects.TracesListRequest, requestOptions?: Traces.RequestOptions): core.HttpResponsePromise<MirascopeApi.PaginatedSpanPublic>;
    private __list;
    /**
     ...
     */
    create(projectUuid: string, requestOptions?: Traces.RequestOptions): core.HttpResponsePromise<MirascopeApi.TracesQueueResponse>;
    private __create;
