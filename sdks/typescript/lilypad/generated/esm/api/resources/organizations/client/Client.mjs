...
import { Invites } from "../resources/invites/client/Client.mjs";
export class Organizations {
    ...
    get invites() {
        var _a;
        return ((_a = this._invites) !== null && _a !== void 0 ? _a : (this._invites = new Invites(this._options)));
    }
    /**
    ...
    __update() {
        return __awaiter(this, arguments, void 0, function* (request = {}, requestOptions) {
            ...
            const _response = yield core.fetcher({
                url: core.joinUrl((_a = (yield core.Supplier.get(this._options.baseUrl))) !== null && _a !== void 0 ? _a : (yield core.Supplier.get(this._options.environment)), "organizations"),
                method: "PATCH",
