...
const setupPostgresMocks = async () => {
  ...
  return { postgresDefault, drizzle };
};

const setupAllMocks = async () => {
  const { neon } = await import('@neondatabase/serverless');
  ...
  return { neon, drizzleNeon, postgresDefault, drizzlePostgres };
};
...
describe('Database Utilities', () => {
  ...
  describe('createNeonDbConnection', () => {
    beforeEach(async () => {
      await setupNeonMocks();
    });

    it('should create Neon database connection', async () => {
      const { neon, drizzle } = await setupNeonMocks();
    ...
    it('should handle different Neon URL formats', async () => {
      const { neon } = await setupNeonMocks();
  ...
  describe('createPostgresDbConnection', () => {
    beforeEach(async () => {
      await setupPostgresMocks();
    });

    it('should create PostgresJS database connection', async () => {
      const { postgresDefault, drizzle } = await setupPostgresMocks();
    ...
    it('should handle different PostgreSQL URL formats', async () => {
      const { postgresDefault } = await setupPostgresMocks();
  ...
  describe('createDbConnection', () => {
    ...
    it('should create Neon connection for neon.tech URLs', async () => {
      const { neon, drizzleNeon: drizzle } = await setupAllMocks();
    ...
    it('should create PostgresJS connection for non-Neon URLs', async () => {
      const { postgresDefault, drizzlePostgres: drizzle } =
        await setupAllMocks();
    ...
    it('should handle various non-Neon URL formats', async () => {
      const { postgresDefault } = await setupAllMocks();
    ...
    it('should be case sensitive for Neon detection', async () => {
      const { postgresDefault, neon } = await setupAllMocks();
