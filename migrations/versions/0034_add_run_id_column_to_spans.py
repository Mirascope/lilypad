...
def downgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['function_uuid'], ['functions.uuid'], name='function_tags_function_uuid_functions_fkey'),
    sa.ForeignKeyConstraint(['tag_uuid'], ['tags.uuid'], name='function_tags_tag_uuid_tags_fkey'),
