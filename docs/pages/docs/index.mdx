...
export const providers = ["OpenAI", "Anthropic", "Gemini", "Mistral", "OpenRouter"];
...
<Tabs items={["OpenAI", "Anthropic", "Gemini", "Mistral", "OpenRouter"]} storageKey="provider">
  <Tabs.Tab>
  ```python
  import lilypad
