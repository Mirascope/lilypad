...
function Card({
  ...
  return (
    ...
    >
      {children}
      <div className='_flex _flex-col _gap-1 _p-4'>
        <span
          className={cn(
            "_flex _font-semibold _items-center _gap-2 _text-gray-700 hover:_text-gray-900",
            arrow &&
        ...
        {description && (
          <p
            className={cn(
              "_text-sm _text-gray-500 dark:_text-gray-400",
              "group-hover:_text-gray-600 dark:group-hover:_text-gray-300"
            )}
          >
            {description}
          </p>
