...
def _generate_protocol_stub_content(
    ...
    for version in sorted_versions:
        ...
        overload = (
            f"    @classmethod\n"
            f"    @overload\n"
            f"    def version(cls, forced_version: Literal[{version.version_num}], override_sandbox_factory: SandBoxFactory[SandBoxRunnerT] | None = None) -> {version_class_name}: ..."
        )
    ...
    base_version = (
        ...
        f"    def version(cls, forced_version: int, override_sandbox_factory: SandBoxFactory[SandBoxRunnerT] | None = None) -> Callable[..., "
...
from lilypad.generations import SandBoxFactory, SandBoxRunnerT
