...
class _OrganizationInviteBase(SQLModel):
...
class OrganizationInviteTable(
    _OrganizationInviteBase, BaseOrganizationSQLModel, table=True
):
...
class OrganizationInvitePublic(_OrganizationInviteBase):
...
class OrganizationInviteCreate(_OrganizationInviteBase):
